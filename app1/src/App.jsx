...
function App() {
  return (
    <div className=''>
      <h1 className='text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 mb-4 text-center drop-shadow-md'>Welcome to Application One</h1>
