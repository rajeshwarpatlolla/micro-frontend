            ...
            <div className="grid grid-cols-2 gap-4">
              {apps.map((app) => (
                <div
                  ...
                  className="p-4 border border-gray-100 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-blue-50 hover:to-pink-50 transition-colors shadow-sm hover:shadow-md text-center"
                >
                  ...
                  <div className='flex flex-col items-center'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 w-full max-w-3xl'>
                      {appsConfig.apps.map(app => (
                        ...
                        >
                          <h3 className='text-xl font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors'>{app.name}</h3>
